    ...
    return (
      <>
        ...
        <nav css={SiteNavStyles}>
          <SiteNavLeft className="site-nav-left">
            ...
            <SiteNavContent css={[this.state.showTitle ? HideNav : '']}>
              <ul css={NavStyles} role="menu">
                <li role="menuitem">
                  <Link to="/" activeClassName="nav-current">Accueil</Link>
                </li>
                <li role="menuitem">
                  <Link to="/about" activeClassName="nav-current">About</Link>
                </li>
                <li role="menuitem">
                  <Link to="/tags/getting-started/" activeClassName="nav-current">Blogs</Link>
                </li>
                <li role="menuitem">
                  <a  href="https://justheal-integration.netlify.app/" > Espace integration </a> 
                </li>
              </ul>
              {isPost && (
          ...
          <ul css={NavStyles} role="menu">
                <li role="menuitem">
          <a href="https://i.ibb.co/Z88SSkr/frame.png">TELECHARGER L'APPLICATION </a>  
          </li></ul>
            {/* <SocialLinks>
              {config.facebook && (
                <a
